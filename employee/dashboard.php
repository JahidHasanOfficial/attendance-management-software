    ...
    <div class="col-md-8">
        <div class="card p-4 h-100">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <span class="text-muted fw-semibold"><?php echo date('l, d M Y'); ?></span>
            </div>
            ...
            <div class="bg-light p-4 rounded text-center">
                <?php if (!$today_attendance): ?>
                    <form id="attendanceForm" action="mark_attendance.php" method="POST">
                        ...
                        <button type="button" onclick="getLocation()" class="btn btn-primary btn-lg px-5 py-3 rounded-pill fw-bold shadow-sm">
                            <i class="bi bi-box-arrow-in-right me-2"></i> CHECK IN NOW
                        </button>
                    </form>
                    <p id="locationStatus" class="mt-3 text-muted">Click the button to check in from your branch.</p>
                <?php elseif ($today_attendance && !$today_attendance['check_out']): ?>
                    <div class="mb-4">
                        <div class="h1 fw-bold text-success mb-0"><?php echo date('h:i A', strtotime($today_attendance['check_in'])); ?></div>
                        <div class="text-uppercase small fw-bold text-muted">Check In Time</div>
                    </div>
                    <form action="mark_attendance.php" method="POST">
                        <input type="hidden" name="action" value="check_out">
                        <button type="submit" class="btn btn-warning btn-lg px-5 py-3 rounded-pill fw-bold shadow-sm text-white">
                ...
                <?php else: ?>
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="h3 fw-bold text-danger mb-0"><?php echo date('h:i A', strtotime($today_attendance['check_out'])); ?></div>
    ...
    <div class="col-md-4">
        <div class="card p-4 h-100">
            ...
            <div class="mb-4 p-3 bg-light rounded d-flex justify-content-between align-items-center">
                ...
                <i class="bi bi-calendar-check h1 text-primary opacity-25"></i>
            </div>
            ...
            <div class="p-3 bg-light rounded d-flex justify-content-between align-items-center">
                ...
                <i class="bi bi-clock-history h1 text-warning opacity-25"></i>
            </div>
        </div>
    </div>
</div>
